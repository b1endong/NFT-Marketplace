...
import {KSeaNFTMarketplaceDeploy} from "../../script/KSeaNFTMarketplaceDeploy.s.sol";
import {LISTING_PRICE, FEE_PERCENTAGE} from "../../src/Constant.sol";

contract KSeaNFTMarketplaceIntegrationTest is Test {
    KSeaNFTMarketplace private kSeaNFTMarketplace;
    KSeaNFTMarketplaceDeploy private deployer;
    ...
    function setUp() public {
        deployer = new KSeaNFTMarketplaceDeploy();
        kSeaNFTMarketplace = deployer.run();
    ...
    function testMarketplaceSetUp() public view {
        ...
        // assertEq(kSeaNFTMarketplace.getOwner(), owner); // Now owner is correct
    }
    ...
    function testAdminFunctions() public listNFTs {
        ...
        console.log(amount);
        // vm.expectEmit();
        // emit Withdrawals(address(deployer), amount);
